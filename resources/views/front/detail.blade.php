...
<body class="text-portto-black font-poppins">
                ...
                <div class="flex gap-4">
                    <div class="flex items-center gap-1 bg-[#F4F5F8] p-[8px_10px] rounded-[12px]">
                        <div class="w-5 h-5 flex shrink-0">
                            <img src="{{ asset('assets/images/icons/crown-black.svg') }}" alt="icon">
                        </div>
                        <p class="font-semibold">Startup</p>
                    </div>
                    <div class="flex items-center gap-1 bg-[#F4F5F8] p-[8px_10px] rounded-[12px]">
                        <div class="w-5 h-5 flex shrink-0">
                            <img src="{{ asset('assets/images/icons/code-black.svg') }}" alt="icon">
                        </div>
                        <p class="font-semibold">Future AI</p>
                    </div>
                    <div class="flex items-center gap-1 bg-[#F4F5F8] p-[8px_10px] rounded-[12px]">
                        <div class="w-5 h-5 flex shrink-0">
                            <img src="{{ asset('assets/images/icons/chart-2-black.svg') }}" alt="icon">
                        </div>
            ...
            <div class="grid grid-cols-4 gap-5">
                ...
                @forelse ($project->screenshots as $screenshot)
                    <a href="{{ Storage::url($screenshot->screenshot) }}" class="group w-full h-[190px] flex overflow-hidden rounded-[30px] ring-1 ring-[#E4E5E8] transition-all duration-300 hover:ring-[3px] hover:ring-portto-purple relative" data-fancybox="gallery" data-caption="Screenshot #1">
                        ...
                        <img src="{{ Storage::url($screenshot->screenshot) }}" class="absolute transition-all duration-300 opacity-0 group-hover:opacity-100  transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 z-10" alt="icon eye">
                    </a>
                @empty
                    <p>Project Belum Tersedia</p>
                @endforelse
            </div>
        </div>
    </section>
        ...
        <div class="flex gap-[100px] items-center px-[65px] pt-[100px]">
            <div class="flex flex-col gap-5 relative">
                <div class="flex w-[200px] h-[250px] rounded-[30px] shrink-0 overflow-hidden z-10">
                    <img src="{{ asset('assets/images/photo/photo5.png') }}" alt="photo">
                </div>
                ...
                <img src="{{ asset('assets/images/icons/quote.svg') }}" class="absolute transform -translate-x-1/2 -translate-y-1/2 left-[21px] top-[14px]" alt="icon">
            </div>
            <div class="flex flex-col gap-[50px]">
                <div class="flex shrink-0">
                    <img src="{{ asset('assets/images/logos/logo-testi5.svg') }}" alt="logo">
                </div>
                ...
                <div class="flex h-8 w-fit shrink-0">
                    <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-full h-full" alt="star">
                    <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-full h-full" alt="star">
                    <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-full h-full" alt="star">
                    <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-full h-full" alt="star">
                    <img src="{{ asset('assets/images/icons/Star.svg') }}" class="w-full h-full" alt="star">
    ...
    <section id="Book"  class="container max-w-[1130px] mx-auto">
        <div class="bg-portto-black flex justify-between px-[50px] rounded-[50px] h-[476px] mt-[100px] bg-[url('{{ asset('assets/images/Ellipse.svg') }}')] bg-center bg-no-repeat bg-contain bg-[length:400px_400px] relative">
            ...
            <div class="flex flex-col gap-5 items-center justify-center text-center w-fit">
                ...
                <a href="{{ route('book') }}" class="bg-portto-light-gold font-bold text-lg p-[14px_30px] rounded-full transition-all duration-300 hover:shadow-[0_10px_20px_0_#FFE7C280]">Book a Meeting</a>
            </div>
            <div class="group/projects w-[220px] overflow-hidden">    
                <div class="slider flex flex-col h-max justify-center">
